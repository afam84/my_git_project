<%-- 
    ...
    Created on : May 9, 2020, 5:49:39 PM
    Author     : USER
--%>

<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,java.util.*,com.example.bank.BankCommons" errorPage="" %>
<%
//java Code
...
<p>&nbsp;</p>	</td>
	...
	<form id="form1" name="form1" method="post" action="">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <th colspan="3" bgcolor="#333333" scope="col"><font color="#FFFFFF">Your Current Balance is As Follows </font></th>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3">&nbsp;If you want to Deposit then <a href="deposit.jsp">Click Here</a><br/> Or For Withdraw the Amount fro Your Account <a href="withdraw.jsp">Click here</a></td>
          </tr>
        <tr>
          <td width="43%">&nbsp;</td>
          <td width="2%">&nbsp;</td>
