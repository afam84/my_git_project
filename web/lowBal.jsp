<%-- 
    Document   : lowBal
    Created on : May 9, 2020, 6:10:32 PM
    Author     : USER
--%>

<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,com.example.bank.BankCommons" errorPage="" %>
...
<p>&nbsp;</p>	</td>
	...
	Your No not have Sufficient Balance to Transfer Amount. To deposit some Amount <a href="deposit.jsp">Click Here</a> <br/>
