<%-- 
    Document   : deposit
    Created on : May 9, 2020, 5:38:35 PM
    Author     : USER
--%>
	...
	<form id="form1" name="form1" method="post" action="doDeposit.jsp">
	  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><label>
            <input name="Submit" type="submit" onclick="MM_validateForm('Amount','','RisNum');return document.MM_returnValue" value="Deposit Amount" />
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
